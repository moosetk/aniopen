...
document.write('<link rel="manifest" href="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.0.9/manifest.json">');
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.0.9/DPlayer.min.js"></script>');
...
function file_video(path) {
    ...
    if (/(Android)/i.test(navigator.userAgent)) { //Android
        var playBtn = `<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-deep-purple-900 onclick="javascript:location.href='${vlc}'"><i class="mdui-icon material-icons">&#xe039;</i> 在 VLC media player 中播放</a>`;
    }
